...
public class OnlineMaps : MonoBehaviour
{
    ...
    /// </summary>
    public static int maxTileDownloads = 15;
    ...
    internal void CheckBufferComplete()
    {
    ...
    public void DispatchEvent(params OnlineMapsEvents[] evs)
    {
        ...
        {
            if (ev == OnlineMapsEvents.changedPosition && OnChangePosition != null)
            {
                OnChangePosition();
            }
            else if (ev == OnlineMapsEvents.changedZoom && OnChangeZoom != null)
            {
                OnChangeZoom();
            }
        }
    ...
    private void OnGUI()
    {
        ...
        if (!string.IsNullOrEmpty(tooltip))
        {
            if (tooltipMarker != null)
            {
                ...
                {
                    OnGUITooltip(style, tooltip, Input.mousePosition);
                }
            }
